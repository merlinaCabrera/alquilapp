...
class PlacesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create place" do
    assert_difference("Place.count") do
      post places_url, params: { place: { latitud: @place.latitud, longitud: @place.longitud } }
    end
  ...
  test "should update place" do
    patch place_url(@place), params: { place: { latitud: @place.latitud, longitud: @place.longitud } }
